...
df = pd.read_sql_query("Select * from CellLocation", conn)
...
conn = sqlite3.connect("cache_encryptedB.db")
df = pd.read_sql_query("Select * from LteCellLocation", conn)
...
conn = sqlite3.connect("cache_encryptedB.db")
df = pd.read_sql_query("Select * from LteCellLocationLocal", conn)
...
conn = sqlite3.connect("cache_encryptedB.db")
df = pd.read_sql_query("Select * from WifiLocation", conn)
